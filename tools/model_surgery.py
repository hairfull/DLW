...
if __name__ == '__main__':
    ...
    parser.add_argument('--src-path', type=str, default='/home/wxq/od/DeFRCN/checkpoints/rdd/base/model_final.pth', help='Path to the main checkpoint')
    parser.add_argument('--save-dir', type=str, default='/home/wxq/od/DeFRCN/checkpoints/rdd/base/', help='Save directory')
